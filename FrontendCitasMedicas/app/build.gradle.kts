...
android {
    namespace = "com.example.frontcitasmedicas"
    ...
    defaultConfig {
        applicationId = "com.example.frontcitasmedicas"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation ("androidx.compose.material3:material3:1.2.0") // o más reciente
